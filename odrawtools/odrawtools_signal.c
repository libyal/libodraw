...
void (*odrawtools_signal_signal_handler)( odrawtools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( odrawtools_signal_signal_handler != NULL )
			{
				odrawtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void odrawtools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int odrawtools_signal_attach(
     void (*signal_handler)( odrawtools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "odrawtools_signal_attach";
...
#if defined( _MSC_VER )
	odrawtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	odrawtools_signal_signal_handler = NULL;
