...
#if !defined( _ODRAWTOOLS_GETOPT_H )
#define _ODRAWTOOLS_GETOPT_H
...
typedef struct odrawtools_option odrawtools_option_t;

struct odrawtools_option
{
...
#define odrawtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t odrawtools_getopt(
                  int argument_count,
...
void odrawtools_getopt_wrapped_fprint(
      FILE *stream,
...
void odrawtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const odrawtools_option_t *options,
      int number_of_options );

int odrawtools_getopt_get_options_string(
     const odrawtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _ODRAWTOOLS_GETOPT_H ) */
