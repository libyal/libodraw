...
#if !defined( _ODRAW_TEST_LIBCTHREADS_H )
#define _ODRAW_TEST_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBODRAW )
...
#endif /* defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBODRAW ) */
