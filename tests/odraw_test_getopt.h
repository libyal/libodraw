...
#if !defined( _ODRAW_TEST_GETOPT_H )
#define _ODRAW_TEST_GETOPT_H
...
#define odraw_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t odraw_test_getopt(
                  int argument_count,
...
#endif /* !defined( _ODRAW_TEST_GETOPT_H ) */
