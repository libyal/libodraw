...
ODRAW_TEST_SET_ASCII_CODEPAGE="odraw_test_set_ascii_codepage";

if ! test -x ${ODRAW_TEST_SET_ASCII_CODEPAGE};
then
	ODRAW_TEST_SET_ASCII_CODEPAGE="odraw_test_set_ascii_codepage.exe";
fi

if ! test -x ${ODRAW_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${ODRAW_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${ODRAW_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
